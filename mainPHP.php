...
if (isset($_SESSION["game"])) {
  echo $_SESSION["game"];
    ...
    if (isset($_GET["dificultad"])) {
      ...
      if($dificultad == "Easy"){
        ...
        $file =fopen("resources/diccionarios/listaPalabrasFacil", "r");
    	  $dificultadHTML = "<input id='difficulty' type='hidden' value='easy'>";
        ...
        $file =fopen("resources/diccionarios/listaPalabrasMedio", "r");
    	  $dificultadHTML = "<input id='difficulty' type='hidden' value='normal'>";
        ...
        $file =fopen("resources/diccionarios/listaPalabrasDificil", "r");
    	  $dificultadHTML = "<input id='difficulty' type='hidden' value='hard'>";
      ...
      $dificultadHTML = "<input id='difficulty' type='hidden' value='easy'>";
    	...
    	if(isset($_GET["hardcore"])){
    		...
    		$hardCoreHTML = "<input id='hardcore' type='hidden' value='True'>";
    ...
    $passwordHTML = "<p id='contrasena'>$contrasena</p>";
    ...
    $stringPrincipalHTML = "<div id='mainPalabras'><div id='bloquepalabras1'>".$stringPrincipal."</div></div>";

    $variablesSesion = $dificultadHTML . $hardCoreHTML . $passwordHTML . $stringPrincipalHTML;

    $_SESSION["game"] = $variablesSesion;

    echo $variablesSesion;
}
?>
